...
public class VirtualMachineAgent extends Agent {
    ...
    private final double[] muCPUUsageLongTermMean = {Consts.LOW_LONGTERM_MEAN_FOR_CPU_USAGE, Consts.MEDIUM_LONGTERM_MEAN_FOR_CPU_USAGE, Consts.HIGH_LONGTERM_MEAN_FOR_CPU_USAGE};
    private final double[] muMemoryUsageyLongTermMean = {Consts.LOW_LONGTERM_MEAN_FOR_MEMORY_USAGE, Consts.MEDIUM_LONGTERM_MEAN_FOR_MEMORY_USAGE, Consts.HIGH_LONGTERM_MEAN_FOR_MEMORY_USAGE};
    ...
    private void updateVirtualMachineResourceConsumption() {
        double sigmaCPU = 3;
        double rhoCPU = 0.995; // correlation degree 0 - 1
        ...
        double rhoMemory = 0.995; // correlation degree 0 - 1
        rn = Math.random();
