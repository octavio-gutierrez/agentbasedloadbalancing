...
public final class Consts {
    ...
    public static final long RANGE_OF_RANDOM_TICKS = HOST_REPORTING_RATE/20; // This is to prevent Host Agents from initiating CNPs at the same time.
    ...
    public static final int VMWARE_MAX_MIGRATIONS = 10;
